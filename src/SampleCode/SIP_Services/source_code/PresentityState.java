...
public class PresentityState implements Serializable
{
    ...
    public PresentityState(String basic, String note)
    {
        if (basic == null)
        {
            throw new NullPointerException("basic");
        }
        ...
        else
        {
            if (o instanceof PresentityState)
            {
                if (((PresentityState) o).basic.equals(basic))
                {
                    ...
                    if ((note == null && otherNote == null) || (note != null && note.equals(otherNote)))
                    {
                        return true;
                    }
                }
    ...
    private String correctBasicState(String basic)
    {
        ...
        if (basic.toLowerCase().matches("open"))
        {
            return OPEN;
        }
        if (basic.toLowerCase().matches("close\\D?"))
        {
            return CLOSED;
        }
        return basic;
