...
public abstract class PresenceAwareSbb extends OCSipSbb
{
    ...
    {
        if (sipAddressOfRecord == null)
        {
            throw new NullPointerException("sipAddressOfRecord");
        }
    ...
    private class PresenceAciManager
    {
        ...
        PresenceAciManager(String addressOfRecord)
        {
            ...
            {
                throw new NullPointerException("Error creating PresenceAciManager: addressOfRecord is null");
            }
