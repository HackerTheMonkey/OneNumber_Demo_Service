...
public abstract class BaseSbb implements Sbb
{
    ...
    protected final Tracer getSbbTracer()
    {
        return sbbTracer;
    }
    ...
    protected final void config(String message)
    {
        trace(TraceLevel.CONFIG, message);
    }

    protected final void config(String message, Throwable t)
    {
        trace(TraceLevel.CONFIG, message, t);
    }
    ...
    {
        trace(TraceLevel.INFO, message, t);
    }

    protected final void fine(String message)
    {
        trace(TraceLevel.FINE, message);
    }

    protected final void fine(String message, Throwable t)
    {
        trace(TraceLevel.FINE, message, t);
    }

    protected final void finer(String message)
    {
        trace(TraceLevel.FINER, message);
    }

    protected final void finer(String message, Throwable t)
    {
        trace(TraceLevel.FINER, message, t);
    }

    protected final void finest(String message)
    {
        trace(TraceLevel.FINEST, message);
    }

    protected final void finest(String message, Throwable t)
    {
        trace(TraceLevel.FINEST, message, t);
    }
    ...
    {
        trace(TraceLevel.WARNING, message, t);
    }

    protected final void severe(String message)
    {
        trace(TraceLevel.SEVERE, message);
    }

    protected final void severe(String message, Throwable t)
    {
        trace(TraceLevel.SEVERE, message, t);
    }
