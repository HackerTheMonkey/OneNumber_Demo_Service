...
public class ContactImpl implements Registration.Contact, Serializable
{
    ...
    public ContactImpl(String contact, float qValue, long expireTime, String callId, int cseq, FlowID flowID)
    {
        ...
        {
            throw new IllegalArgumentException("qValue");
        }
        if (expireTime < 0)
        {
            throw new IllegalArgumentException("expireDelta");
        }
        if (cseq < 0)
        {
            throw new IllegalArgumentException("cseq");
        }
    ...
    public TimerID getExpiryTimer()
    {
        return timerID;
    }

    public void setExpiryTimer(TimerID id)
    {
        timerID = id;
    }
